...
def new_items():
    '''
    returns dataframe of all the items on all the pages
    '''
    items_list = []
...
def get_items():
    '''
    returns dataframe of all items from items.csv, or creates items.csv if one doesn't
    already exist
    '''
...
def new_stores():
    '''
    returns dataframe of stores by cycling through all the pages
    '''
    stores_list = []
...
def get_stores():
    '''
    returns dataframe of stores from stores.csv, or creates it for you if it doesn't exist
    '''
...
def get_sales():
    '''
    retrieves sales dataframe from sales.csv, or creates it for you if doesn't already exist
    '''
...
def combined_data():
    '''
    combines items, stores, and sales into one dataframe by changing columns keys per table 
    to match and using pd.merge
    '''
...
def get_germany_power():
    '''
    returns Germany power data into a csv, and creates it for you if it doesn't already exist
    '''
